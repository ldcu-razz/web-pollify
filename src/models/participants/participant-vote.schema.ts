...
import { PollCandidateWithPartylistSchema } from "@models/polls/poll-candidate.schema";
import { z } from "zod";
...
export const GetParticipantVoteSchema = z.object({
  ...
  poll_candidates: z.array(PollCandidateWithPartylistSchema),
});

export const PollPositionWithCandidateSchema = z.object({
  position: PollPositionsSchema,
  candidates: z.array(PollCandidateWithPartylistSchema),
