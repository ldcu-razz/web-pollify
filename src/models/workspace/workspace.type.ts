import { z } from "zod";
import { DeleteWorkspaceSchema, GetWorkspaceSchema, GetPaginatedWorkspacesSchema, PatchWorkspaceSchema, PostWorkspaceSchema, PutWorkspaceSchema, WorkspaceSchema, WorkspaceUserRolesSchema } from "./workspace.schema";
